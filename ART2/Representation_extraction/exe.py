...
def main():
    ...
    # 2) RUN THE MODEL
    # Default is the average of the last few layers: the methodology notes the
    # final layer is not always best, and for bidirectional models averaging
    # the last layers is a robust starting point.
    layer_mode = choose(
        "\nWhich layer(s) to extract?",
        [mr.LAYER_AVG_LAST_N, mr.LAYER_LAST], mr.LAYER_AVG_LAST_N)
