...
Two strategies, as the methodology describes:
  ...
  - REPRESENTATIVE TOKEN: take one token's vector ([CLS] for bidirectional
    models, the last token for autoregressive ones). Only appropriate when the
    model is trained so that one token summarizes the sequence.
